## Kenny Warner
## Running a PCA to determine what stock / company has the biggest
## effect on the Dow Jones Industrial Average

# download data from Yahoo's finance section
...
baseLoc = "/Users/kenny/Documents/Intro Data Science/"
